...
CREATE OR REPLACE PROCEDURE Insert_products(p_name TEXT, p_description TEXT, p_price NUMERIC, p_stock INT, p_weight NUMERIC,
...
CREATE OR REPLACE PROCEDURE Delete_products(p_id INT)
LANGUAGE plpgsql
AS $$
BEGIN
...
CREATE OR REPLACE PROCEDURE Update_products(p_name TEXT, p_description TEXT, p_price NUMERIC, p_stock INT, p_weight NUMERIC,
                                                                                    p_sizes TEXT, p_isActive BOOLEAN, p_categoryId INT, p_brandId INT, p_createdBy INT, p_updatedBy INT)
    ...
    BEGIN
        UPDATE products SET 
                                            name = p_name, description = p_description, price = p_price, stock = p_stock, weight = p_weight, sizes = p_sizes, isActive = p_isActive,
