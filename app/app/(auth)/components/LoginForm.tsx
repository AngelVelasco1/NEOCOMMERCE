        ...
        <div className="max-w-md w-full">
          ...
          <div className="p-8 rounded-2xl bg-white shadow">
            ...
            <form className="mt-12 space-y-6">
              ...
              <p className="text-slate-800 text-sm !mt-6 text-center">Don't have an account? <a href="../register" className="text-blue-600 hover:underline ml-1 whitespace-nowrap font-semibold">Register here</a></p>
            </form>
          </div>
        </div>
      </div>
