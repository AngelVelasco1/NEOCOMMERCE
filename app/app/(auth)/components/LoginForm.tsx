        ...
        <div className="max-w-md w-full">
          ...
          <div className="p-8 rounded-2xl bg-white shadow">
            ...
            <form className="mt-12 space-y-6">
              <div>
                <label className="text-slate-800 text-sm font-medium mb-2 block">Usuario</label>
                <div className="relative flex items-center">
                  <input name="username" type="text" required className="w-full text-slate-800 text-sm border border-slate-300 px-4 py-3 rounded-md outline-blue-600" placeholder="Escribe usuario" />
              ...
              <div>
                ...
                <div className="relative flex items-center">
                  <input name="password" type="password" required className="w-full text-slate-800 text-sm border border-slate-300 px-4 py-3 rounded-md outline-blue-600" placeholder="Escribe contraseña" />
              ...
              <p className="text-slate-800 text-sm !mt-6 text-center">¿No tienes una cuenta? <a href="../register" className="text-blue-600 hover:underline ml-1 whitespace-nowrap font-semibold">Regístrate aquí</a></p>
            </form>
          </div>
        </div>
      </div>
